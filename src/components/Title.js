const Title = ({longBoots , link}) => {
    return ( 
        <div className=" p-smPadd md:my-10 xl:my-24 xl:gap-7  sm:gap-3 flex justify-center items-center flex-col">
           ...
           <a href={link}> <button className="w-fit px-4 py-2 md:px-7 md:py-3 bg-light-brown text-secondary-white roundelgherod text-ptextsm lg:px-8 lg:py-2 xl:px-8 xl:py-3 xl:text-sometxt font-playPlayfair lg:text-smm rounded-md md:text-mdp">{longBoots.btn}</button></a>
        </div>
     );
}
